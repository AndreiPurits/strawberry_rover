...
def main() -> int:
    ap = argparse.ArgumentParser(description="Train yolov8s on resplit dataset_v2 with early stopping.")
    ap.add_argument("--data", default=str(REPO_ROOT / "data" / "yolo_detection_dataset_v2" / "data.yaml"))
    ap.add_argument("--device", default="0")
    ap.add_argument("--epochs", type=int, default=150)
    ap.add_argument("--patience", type=int, default=20)
    ap.add_argument("--imgsz", type=int, default=640)
    ap.add_argument("--batch", type=int, default=32, help="Safe default. Increase if you know it fits.")
    ap.add_argument("--workers", type=int, default=4)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--project", default=str(REPO_ROOT / "runs" / "detect_benchmark_v2"))
    ap.add_argument("--name", default="yolov8s_v2_resplit")
